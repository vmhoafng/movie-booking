...
export const createBill = createAsyncThunk<any, boolean, { state: RootState }>(
   "@@auth/createBill",
   async (isUsingPoint, thunkApi) => {
...
export const { setTicket, setSelectedSeats, clearSelectedSeats } =
