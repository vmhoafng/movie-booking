...
function MobileFooter() {
  return <div className="bg-primary h-[146px] py-[8px] items-center flex flex-col md:min-w-[395px] md:gap-[20px]">
    <div className=" flex md:w-[395px] justify-between h-[50px] border-b-2 border-[#314C81]">
      <div className="flex md:w-[123px] min-w-[80px] max-w-[150px]  py-[10px] justify-center items-center shrink-0 rounded-3xl ">
        <img className=" "
          src={"/images/Logo.png"} />
      </div>
      <div className="bg-primary flex md:w-[120px] justify-end items-center gap-[15px] shrink-0">
    ...
    <div className=" block md:w-[365px] h-[52px] gap-[24px] ">
      {/* <div className="hidden md:static md:text-base text-textinf flex ">
        <p className="">Copyright © 2023.All Rights Reserved By </p>
        <p className="text-highlight"> CNPM-Team</p>
      </div> */}
      <div className="text-textinf text-xs md:w-[365px] flex items-center shrink-0 justify-center md:gap-[35px] ">
        <a href="/">About</a>
      ...
      <div className="lg:hidden text-textinf flex text-xs items-center justify-center pt-[24px] ">
        <p className="">Copyright © 2023.All Rights Reserved By</p>
        <p className="text-highlight "> CNPM-Team</p>
      </div>
    </div>
