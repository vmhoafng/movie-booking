...
function MobileNavbar() {
	...
	return <div className="bg-primary h-[96px] items-center justify-between w-full">
		<div className="h-[96px] md:w-[1200px] items-center flex justify-between mx-auto">
			...
			<div onClick={() => setOpen(!open)} className="cursor-pointer md:hidden">
				{open ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-white w-6 h-6">
					<path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
				</svg> : <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-white w-6 h-6">
					<path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
				</svg>}
			</div>
