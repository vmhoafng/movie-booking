          ...
          <div className="w-full xl:flex xl:gap-14 2xl:gap-24">
            <div className="xl:w-[calc(100%-300px-80px)] lg:text-sm lg:py-2 xl:flex-1 2xl:w-auto">
              ...
              <div className="flex flex-col gap-4 justify-center items-start py-6 lg:py-8 border-b border-dashed border-borderColor">
                ...
                <p className="text-white/60 md:text-sm">{detail.description}</p>
              </div>
              <div className="w-full overflow-hidden flex flex-col gap-4 justify-center items-start py-6 lg:py-8 border-b border-dashed border-borderColor">
                <div className="flex gap-6">
                  <Title active={trailer} onClick={() => setTrailer(true)}>
                    Trailer
                  </Title>
                  <Title
                    active={!trailer}
                ...
                <div className="w-full h-[280px] md:h-[358px] lg:h-[444px] xl:h-[400px] 2xl:h-[500px] flex justify-center items-center">
                  {trailer ? (
                    <iframe
                      title="trailer"
                    ...
                    >
                      {(detail.images || []).map((img, index) => {
                        return (
                          <SwiperSlide key={`${detail.name}-image-${index}`}>
              ...
              <div className="flex flex-col gap-4 justify-center items-start py-6 lg:py-8 border-b border-dashed border-borderColor">
                ...
                <div className="flex  flex-col w-full justify-start md:items-center items-start gap-2">
                  <Listbox value={selected} onChange={setSelected}>
                    <div className="relative w-full ">
                      <Listbox.Button
                        className={
                          " w-full h-9 bg-[#EFEFEF]/20 relative rounded border text-left lg:py-2 pl-[15px]"
                        }
                      >
                        <span
                  ...
                  <DatePickSlider
                    value={date}
                    handleOnClick={(date) => setDate(date)}
                  />
                </div>
                {renderShowtimes()}
              </div>
