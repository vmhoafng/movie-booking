...
const Card = ({
   ...
   return (
      <div
         className="w-[290px] h-[160px] flex flex-col justify-between border-[0.5px] border-white/10 p-4 rounded bg-bgPrimaryBar font-inter cursor-pointer shadow-[2px_4px_6px_0px_rgba(0,0,0,0.15)] hover:shadow-[4px_6px_12px_0px_rgba(0,0,0,0.15)] hover:-translate-y-1 transition-all duration-500"
         onClick={onClick}
      >
